        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                    ...
                    <div class="sidebar-brand-text mx-3">LAGUSA FOOD</div>
                </a>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <!-- Topbar Search -->
                        <form action="search" method="GET" class="d-flex" role="search" style="margin-bottom: 20px">
                            <input class="form-control me-2 pe-5 mt-3" type="search" placeholder="Search" aria-label="Search" name="search" autofocus value="{{ old('search') }}">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Content Row -->
                            ...
                            <div class="card-body">
                            <a href="{{ route('blog.create') }}" class="btn btn-md btn-dark mb-3">TAMBAH POST</a>
                            ...
                            confirm('Apakah Anda Yakin ?');" action="{{ route('blog.destroy', $post->id) }}" method="POST">
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright &copy; Lagusa Food 2021</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
